...
//#####################################################################
#ifndef __Vector_Add_Helper__
#define __Vector_Add_Helper__
...
class Vector_Add_Op
    ...
    private:
        ...
        const T* const y;
    public:
        explicit Vector_Add_Op(T* const x_input, const T* const y_input) : x(x_input), y(y_input) {}
...
class Vector_Add_Op<T, 1>
 ...
 template <class T> inline
     void Vector_Add_Helper( T* const x_input, const T* const y_input,
     ...
     {
         Vector_Add_Op<T> op(x_input, y_input);
         Kernel_Base_Helper<Vector_Add_Op<T> > helper(op, block_offsets_input,  number_of_blocks_input,
 ...
 template <class T, class LAYOUT> inline
     ...
     {
         Vector_Add_Op<T> op(x_input, y_input);
         Kernel_Mesh_Base_Helper<Vector_Add_Op<T>,LAYOUT> helper(op, block_layouts_input,  number_of_blocks_input,
                                                        partition_offsets_input,  number_of_partitions_input,
                                                        x_stride_input, y_stride_input, block_size_input);
         helper.Run_Parallel();
     };
 ...
 template <class T> inline
     ...
     {
         Vector_Add_Op<T> op(x_input, y_input);
         Kernel_Serial_Base_Helper<Vector_Add_Op<T> > helper(op,  number_of_entries_input,
...
#if 0
     Vector_Add_Op<T,stride> op(x_input, y_input);
     Kernel_OpenMP_Base_Helper<Vector_Add_Op<T,stride> >helper(op, offsets_input, 
