...
// namespace{
// template<class T>
// struct Vector_Times_Thread_Helper:public PTHREAD_QUEUE::TASK
// {
//     Vector_Times_Helper<T>* const obj;
//     const int index_start,index_end;
//     Vector_Times_Thread_Helper(Vector_Times_Helper<T>* const obj_input,const int index_start_input,const int index_end_input)
...
// template<class T> void Vector_Times_Helper<T>::
// Run_Parallel()
// {
...
//         Vector_Times_Thread_Helper<T>* task=
//             new Vector_Times_Thread_Helper<T>(this,block_begin,block_end);
...
// }
// //#####################################################################
// template class Vector_Times_Helper<float>;
// template class Vector_Times_Helper<double>;

//template class Kernel_Base_Helper<Vector_Times_Op<float> >;
//template class Kernel_Base_Helper<Vector_Times_Op<double> >;
