...
//#####################################################################
#ifndef __Kernel_Mesh_Base_Reducer_Helper__
#define __Kernel_Mesh_Base_Reducer_Helper__
...
namespace MT_Streaming_Kernels{
    ...
    template<class OP, class LAYOUT> class Kernel_Mesh_Base_Reducer_Helper;

    namespace{
        template<class OP, class LAYOUT>
            struct Kernel_Mesh_Base_Reducer_Thread_Helper:public PTHREAD_QUEUE::TASK
            {
                Kernel_Mesh_Base_Reducer_Helper<OP, LAYOUT>* const obj;
                const int block_start,block_end;
                double &result;
            Kernel_Mesh_Base_Reducer_Thread_Helper(Kernel_Mesh_Base_Reducer_Helper<OP, LAYOUT>* const obj_input,const int block_start_input,const int block_end_input, double &result_input)
    ...
    template<class OP, class LAYOUT>
        class Kernel_Mesh_Base_Reducer_Helper
        {
            OP& op;
        ...
        public:
            explicit Kernel_Mesh_Base_Reducer_Helper(OP& op_input,
...
//#####################################################################
            ...
            { 
                ...
                for(int partition=0;partition<number_of_partitions;partition++){
                    ...
                    Kernel_Mesh_Base_Reducer_Thread_Helper<OP, LAYOUT>* task=
                        new Kernel_Mesh_Base_Reducer_Thread_Helper<OP, LAYOUT>(this,block_begin,block_end, partial_results[partition]);
