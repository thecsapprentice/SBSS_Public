...
//#####################################################################
#ifndef __Vector_SAXPY_V8_Helper__
#define __Vector_SAXPY_V8_Helper__
namespace MT_Streaming_Kernels{
    
template<class T, bool ACCUM>
    class Vector_SAXPY_V8_Helper
{
    T* const x_f;
    T* const x_g;
...
public:
    explicit Vector_SAXPY_V8_Helper(T* const x_f_input, T* const x_g_input, 
                              ...
                              const int size)
    {
        for(int i=0;i<size;i++){
            x_f[i]=x_g[i]=T(i);
            v_f_1[i]=v_f_2[i]=v_f_3[i]=v_f_4[i]=T(i); 
            v_g_1[i]=v_g_2[i]=v_g_3[i]=v_g_4[i]=T(i); 
            y_f_1[i]=y_f_2[i]=y_f_3[i]=y_f_4[i]=T(i); 
            y_g_1[i]=y_g_2[i]=y_g_3[i]=y_g_4[i]=T(i); 
        }
    }
