//#####################################################################
// Copyright 2008-2012, Eftychios Sifakis.
...
template<class T,int d> inline typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR&
operator+=(typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR& array,const STENCIL<T,d>& stencil);
template<class T,int d> inline typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR&
Accumulation(typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR& array,const STENCIL<T,d>& stencil,const VECTOR<int,d>& shift,const T scale);
template<class T,int d> inline ARRAY_VIEW<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR::ELEMENT, typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR::TV_INT>
Accumulation(ARRAY_VIEW<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR::ELEMENT, typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR::TV_INT> array,const STENCIL<T,d>& stencil,const VECTOR<int,d>& shift,const T scale);
template<class T,int d> inline typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR&
Accumulation_Cropped(typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR& array,const STENCIL<T,d>& stencil,const VECTOR<int,d>& shift,const T scale);
...
public:
    typedef T ELEMENT;
private:
    typedef typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR T_ARRAYS;
    typedef ARRAY_VIEW<typename T_ARRAYS::ELEMENT, typename T_ARRAYS::TV_INT> T_ARRAYS_VIEW;
    typedef ARRAY_VIEW<const typename T_ARRAYS::ELEMENT, typename T_ARRAYS::TV_INT> T_ARRAYS_VIEW_CONST;
...
public:
    ...
    T operator*(T_ARRAYS_VIEW_CONST array) const
    {T result=0;for(int i=1;i<=entries.m;i++) result+=array(entries(i).x)*entries(i).y;return result;}
...
Contraction(const VECTOR<STENCIL<T,d>,d2>& v1,const VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>& v2,const VECTOR<int,d>& shift)
{T result=0;for(int i=1;i<=d2;i++) result+=v1(i).Contraction(v2(i),shift);return result;}

template<class T,int d,int d2> inline T 
Contraction_Cropped(const VECTOR<STENCIL<T,d>,d2>& v1,const VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>& v2,const VECTOR<int,d>& shift)
{T result=0;for(int i=1;i<=d2;i++) result+=v1(i).Contraction_Cropped(v2(i),shift);return result;}

template<class T,int d,int d2> inline T 
Dot_Product(const VECTOR<STENCIL<T,d>,d2>& v1,const VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>& v2)
...
template<class T,int d,int d2> inline VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>&
operator+=(VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>& v1,const VECTOR<STENCIL<T,d>,d2>& v2)
...
template<class T,int d,class ExistsFunctor> inline typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR&
Accumulation_Cropped(typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR& array,const STENCIL<T,d>& stencil,const VECTOR<int,d>& shift,const T scale,ExistsFunctor exists)
...
template<class T,int d,int d2> inline VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>&
Accumulation_Cropped(VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>& v1,const VECTOR<STENCIL<T,d>,d2>& v2,const VECTOR<int,d>& shift,const T scale)
...
template<class T,int d> inline ARRAY_VIEW<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR::ELEMENT, typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR::TV_INT>
Accumulation(ARRAY_VIEW<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR::ELEMENT, typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR::TV_INT> array,
                 const STENCIL<T,d>& stencil,const VECTOR<int,d>& shift,const T scale)
{for(int i=1;i<=stencil.entries.m;i++) array(stencil.entries(i).x+shift)+=stencil.entries(i).y*scale;return array;}

template<class T,int d,int d2> inline VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>&
Accumulation(VECTOR<typename GRID_ARRAYS_POLICY<GRID<VECTOR<T,d> > >::ARRAYS_SCALAR,d2>& v1,const VECTOR<STENCIL<T,d>,d2>& v2,const VECTOR<int,d>& shift,const T scale)
