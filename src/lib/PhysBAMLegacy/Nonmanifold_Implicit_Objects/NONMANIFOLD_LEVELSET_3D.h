...
//##################################################################### 
#ifndef __NONMANIFOLD_LEVELSET_3D__
#define __NONMANIFOLD_LEVELSET_3D__
...
namespace PhysBAM {
    ...
    template< class T >
    class NONMANIFOLD_LEVELSET_3D : public NONMANIFOLD_LEVELSET_UNIFORM<T,3> {
        
        
    public:
        typedef NONMANIFOLD_LEVELSET_UNIFORM<T,3> BASE;
        ...
        virtual ~NONMANIFOLD_LEVELSET_3D();
