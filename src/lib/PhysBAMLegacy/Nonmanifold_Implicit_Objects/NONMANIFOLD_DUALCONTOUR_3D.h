...
//#####################################################################
// Class NONMANIFOLD_DUALCONTOUR_3D
//##################################################################### 
#ifndef __NONMANIFOLD_DUALCONTOUR_3D__
#define __NONMANIFOLD_DUALCONTOUR_3D__
...
template<class T>
class NONMANIFOLD_DUALCONTOUR_3D:public NONCOPYABLE
{
...
public:
    ...
    NONMANIFOLD_DUALCONTOUR_3D(LEVELSET_3D<GRID<TV> >& levelset_input)
    ...
    {NONMANIFOLD_DUALCONTOUR_3D<T> dualcontour(levelset);dualcontour.Dualcontour();return dualcontour.Get_Triangulated_Surface();} 
