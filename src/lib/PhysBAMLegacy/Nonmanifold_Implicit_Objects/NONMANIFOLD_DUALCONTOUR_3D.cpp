...
#include <Nonmanifold_Implicit_Objects/NONMANIFOLD_DUALCONTOUR_3D.h>
...
//#####################################################################
template<class T> void NONMANIFOLD_DUALCONTOUR_3D<T>::
Generate_Topology()
{
...
//#####################################################################
template<class T> TRIANGULATED_SURFACE<T>* NONMANIFOLD_DUALCONTOUR_3D<T>::
...
//#####################################################################
template class NONMANIFOLD_DUALCONTOUR_3D<float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class NONMANIFOLD_DUALCONTOUR_3D<double>;
#endif
