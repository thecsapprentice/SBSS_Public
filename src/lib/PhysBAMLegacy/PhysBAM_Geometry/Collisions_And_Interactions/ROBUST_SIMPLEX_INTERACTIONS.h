...
public:
    ...
    {triple_products.Clean_Memory();signed_volumes_times_six.Clean_Memory();}
...
public:
    ...
    bool Intersection(const VECTOR<TV,2>& box,const VECTOR<TV,4>& tetrahedron,bool *is_robust_input=0);
//#####################################################################
};   
...
public:
    ...
    void Flush_Intersection_Cache()
    {signed_areas_times_two.Clean_Memory();}
