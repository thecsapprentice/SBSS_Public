...
#define INSTANTIATION_HELPER(T,d) \
    ...
    template void BOX_HIERARCHY<VECTOR<T,d> >::Intersection_List(const int box,const RANGE<VECTOR<T,d> >& test_box,ARRAY<int>& intersection_list,const T thickness_over_two) const; \
    template void BOX_HIERARCHY<VECTOR<T,d> >::Intersection_List(const int box,const VECTOR<T,d>& point,ARRAY<int>& intersection_list,const T thickness_over_two) const;
