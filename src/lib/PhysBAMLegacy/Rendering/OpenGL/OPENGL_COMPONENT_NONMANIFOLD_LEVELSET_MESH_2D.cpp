...
//#####################################################################
#include <Rendering/OpenGL/OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D.h>
using namespace PhysBAM;
//#####################################################################
// Constructor
//#####################################################################
template<class T,class T2,class RW> OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<T,T2,RW>::
OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D(GRID<TV>& grid,const std::string& filename_input,const std::string& flag_filename_input, const std::string& value_filename_input)
    : OPENGL_COMPONENT("Non-manifold Levelset Mesh 2D"),opengl_nonmanifold_levelset_mesh(grid),filename(filename_input),flag_filename(flag_filename_input),value_filename(value_filename_input),frame_loaded(-1),valid(false)
{
...
//#####################################################################
template<class T,class T2,class RW> bool OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<T,T2,RW>::
...
// Function Set_Frame
//#####################################################################
template<class T,class T2,class RW> void OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<T,T2,RW>::
...
//#####################################################################
template<class T,class T2,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<T,T2,RW>::
Bounding_Box() const
{
...
//#####################################################################
template class OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<float,int,float>;
template class OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<float,bool,float>;
template class OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<float,float,float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<double,int,double>;
template class OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<double,bool,double>;
template class OPENGL_COMPONENT_NONMANIFOLD_LEVELSET_MESH_2D<double,double,double>;
#endif
