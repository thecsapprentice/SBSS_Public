...
template void Matrix_Times_Transpose_Reference(const float A[9], const float B[9], float C[9]);
template bool Matrix_Times_Transpose_Compare(const float C[9], const float C_reference[9]);
