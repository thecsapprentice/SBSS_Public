...
template void Unweighted_Gradient_Reference(const float u[3][8], float F[9], const float one_over_h);
template bool Unweighted_Gradient_Compare(const float F[9], const float F_reference[9]);
