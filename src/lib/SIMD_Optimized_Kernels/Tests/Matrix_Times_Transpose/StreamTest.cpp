...
main (int argc, char *argv[])
{
  ...
  {
    std::cout << "Running Stream Test for Matrix_Times_Transpose " << std::endl;
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray2 Bk = reinterpret_cast < refArray2 > (B[0][i]);
              refArray3 Ck = reinterpret_cast < refArray3 > (C[0][i]);
              Matrix_Times_Transpose < __m128, float[16], int[16] > (Ak, Bk,
                                                                     Ck);
            }
          ...
          for (int i = 0; i < 16; i += 8)
            {
              ...
              refArray2 Bk = reinterpret_cast < refArray2 > (B[0][i]);
              refArray3 Ck = reinterpret_cast < refArray3 > (C[0][i]);
              Matrix_Times_Transpose < __m256, float[16], int[16] > (Ak, Bk,
                                                                     Ck);
            }
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray2 Bk = reinterpret_cast < refArray2 > (B[0][i]);
              refArray3 Ck = reinterpret_cast < refArray3 > (C[0][i]);
              Matrix_Times_Transpose < float32x4_t, float[16], int[16] > (Ak,
                                                                          Bk,
                                                                          Ck);
            }
          ...
          for (int i = 0; i < 16; i += 16)
            {
              ...
              refArray2 Bk = reinterpret_cast < refArray2 > (B[0][i]);
              refArray3 Ck = reinterpret_cast < refArray3 > (C[0][i]);
              Matrix_Times_Transpose < __m512, float[16], int[16] > (Ak, Bk,
                                                                     Ck);
            }
