...
main (int argc, char *argv[])
{
  ...
  {
    std::cout << "Running Stream Test for Muscle_Differential " << std::endl;
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray5 c1k = reinterpret_cast < refArray5 > (c1[i]);
              refArray6 c2k = reinterpret_cast < refArray6 > (c2[i]);
              Muscle_Differential < __m128, float[16], int[16] > (dP_fiberk,
                                                                  dFk, fiberk,
                                                                  Ffiberk, c1k,
                                                                  c2k);
            }
          ...
          for (int i = 0; i < 16; i += 8)
            {
              ...
              refArray5 c1k = reinterpret_cast < refArray5 > (c1[i]);
              refArray6 c2k = reinterpret_cast < refArray6 > (c2[i]);
              Muscle_Differential < __m256, float[16], int[16] > (dP_fiberk,
                                                                  dFk, fiberk,
                                                                  Ffiberk, c1k,
                                                                  c2k);
            }
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray5 c1k = reinterpret_cast < refArray5 > (c1[i]);
              refArray6 c2k = reinterpret_cast < refArray6 > (c2[i]);
              Muscle_Differential < float32x4_t, float[16],
                int[16] > (dP_fiberk, dFk, fiberk, Ffiberk, c1k, c2k);
            }
          ...
          for (int i = 0; i < 16; i += 16)
            {
              ...
              refArray5 c1k = reinterpret_cast < refArray5 > (c1[i]);
              refArray6 c2k = reinterpret_cast < refArray6 > (c2[i]);
              Muscle_Differential < __m512, float[16], int[16] > (dP_fiberk,
                                                                  dFk, fiberk,
                                                                  Ffiberk, c1k,
                                                                  c2k);
            }
