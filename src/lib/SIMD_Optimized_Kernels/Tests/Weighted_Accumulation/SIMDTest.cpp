...
main (int argc, char *argv[])
{
  ...
  {
    std::cout << "Running SIMD Test for Weighted_Accumulation " << std::endl;
...
//=======================================================
    ...
    for (int k = 0; k < 16; k++)
    {
      ...
      __mscale = scale[k];
      Weighted_Accumulation < float, float, int >(__mu_reference, __mF, __mW,
...

    {
      ...
      for (int i = 0; i < 16; i += 1)
      {
        ...
        refArray4       one_over_hk =
          reinterpret_cast < refArray4 > (one_over_h[i]);
        refArray5       scalek = reinterpret_cast < refArray5 > (scale[i]);
