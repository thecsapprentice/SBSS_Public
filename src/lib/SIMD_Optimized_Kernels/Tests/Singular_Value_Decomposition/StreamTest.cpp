          ...
          for (int i = 0; i < 16; i += 1)
            {
              ...
              Singular_Value_Decomposition < float, float[16], int[16] > (Ak,
                                                                          Uk,
                                                                          Sk,
                                                                          Vk);
            }
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray3 Sk = reinterpret_cast < refArray3 > (S[0][i]);
              refArray4 Vk = reinterpret_cast < refArray4 > (V[0][i]);
              Singular_Value_Decomposition < __m128, float[16], int[16] > (Ak,
                                                                           Uk,
                                                                           Sk,
                                                                           Vk);
            }
          ...
          for (int i = 0; i < 16; i += 8)
            {
              ...
              refArray3 Sk = reinterpret_cast < refArray3 > (S[0][i]);
              refArray4 Vk = reinterpret_cast < refArray4 > (V[0][i]);
              Singular_Value_Decomposition < __m256, float[16], int[16] > (Ak,
                                                                           Uk,
                                                                           Sk,
                                                                           Vk);
            }
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray3 Sk = reinterpret_cast < refArray3 > (S[0][i]);
              refArray4 Vk = reinterpret_cast < refArray4 > (V[0][i]);
              Singular_Value_Decomposition < float32x4_t, float[16],
                int[16] > (Ak, Uk, Sk, Vk);
            }
          ...
          for (int i = 0; i < 16; i += 16)
            {
              ...
              refArray3 Sk = reinterpret_cast < refArray3 > (S[0][i]);
              refArray4 Vk = reinterpret_cast < refArray4 > (V[0][i]);
              Singular_Value_Decomposition < __m512, float[16], int[16] > (Ak,
                                                                           Uk,
                                                                           Sk,
                                                                           Vk);
            }
