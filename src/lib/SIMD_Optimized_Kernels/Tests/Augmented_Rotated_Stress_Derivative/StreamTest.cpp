...
main (int argc, char *argv[])
{
  ...
  {
    std::
      cout << "Running Stream Test for Augmented_Rotated_Stress_Derivative " <<
      std::endl;
          ...
          for (int i = 0; i < 16; i += 1)
            {
              ...
              Augmented_Rotated_Stress_Derivative < NEOHOOKEAN_TAG, float,
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray4 muk = reinterpret_cast < refArray4 > (mu[i]);
              refArray5 alphak = reinterpret_cast < refArray5 > (alpha[i]);
              Augmented_Rotated_Stress_Derivative < NEOHOOKEAN_TAG, __m128,
                float[16], int[16] >::Run (dPdFk, Sigmak, pk, muk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 8)
            {
              ...
              refArray4 muk = reinterpret_cast < refArray4 > (mu[i]);
              refArray5 alphak = reinterpret_cast < refArray5 > (alpha[i]);
              Augmented_Rotated_Stress_Derivative < NEOHOOKEAN_TAG, __m256,
                float[16], int[16] >::Run (dPdFk, Sigmak, pk, muk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 16)
            {
              ...
              refArray4 muk = reinterpret_cast < refArray4 > (mu[i]);
              refArray5 alphak = reinterpret_cast < refArray5 > (alpha[i]);
              Augmented_Rotated_Stress_Derivative < NEOHOOKEAN_TAG, __m512,
                float[16], int[16] >::Run (dPdFk, Sigmak, pk, muk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 1)
            {
              ...
              refArray4 muk = reinterpret_cast < refArray4 > (mu[i]);
              refArray5 alphak = reinterpret_cast < refArray5 > (alpha[i]);
              Augmented_Rotated_Stress_Derivative < COROTATED_TAG, float,
                float[16], int[16] >::Run (dPdFk, Sigmak, pk, muk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray4 muk = reinterpret_cast < refArray4 > (mu[i]);
              refArray5 alphak = reinterpret_cast < refArray5 > (alpha[i]);
              Augmented_Rotated_Stress_Derivative < COROTATED_TAG, __m128,
                float[16], int[16] >::Run (dPdFk, Sigmak, pk, muk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 8)
            {
              ...
              refArray4 muk = reinterpret_cast < refArray4 > (mu[i]);
              refArray5 alphak = reinterpret_cast < refArray5 > (alpha[i]);
              Augmented_Rotated_Stress_Derivative < COROTATED_TAG, __m256,
                float[16], int[16] >::Run (dPdFk, Sigmak, pk, muk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 16)
            {
              ...
              refArray4 muk = reinterpret_cast < refArray4 > (mu[i]);
              refArray5 alphak = reinterpret_cast < refArray5 > (alpha[i]);
              Augmented_Rotated_Stress_Derivative < COROTATED_TAG, __m512,
                float[16], int[16] >::Run (dPdFk, Sigmak, pk, muk, alphak);
            }
