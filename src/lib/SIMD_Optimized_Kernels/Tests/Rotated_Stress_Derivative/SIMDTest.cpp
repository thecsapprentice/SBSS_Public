...
main (int argc, char *argv[])
{
  ...
  {
    std::cout << "Running SIMD Test for Rotated_Stress_Derivative " << std::
      endl;
...
//=======================================================
    ...
    for (int __a = 0; __a < 3; __a++)
      for (int __b = 0; __b < 16; __b++)
          Sigma[__a][__b] = Get_Random < float >(0,1);
    for (int __a = 0; __a < 16; __a++)
        mu[__a] = Get_Random < float >(0,1);
    for (int __a = 0; __a < 16; __a++)
        kappa[__a] = Get_Random < float >(0,1);
...
//=======================================================
    ...
    for (int k = 0; k < 16; k++)
    {
      ...
      Rotated_Stress_Derivative < NEOHOOKEAN_TAG, float, float,
        int >::Run (__mdPdF_reference, __mSigma, __mmu, __mkappa);
      for (int __a = 0; __a < 12; __a++)
...
//=======================================================

    {
      ...
      for (int i = 0; i < 16; i += 1)
      {
        ...
        refArray4       kappak = reinterpret_cast < refArray4 > (kappa[i]);
