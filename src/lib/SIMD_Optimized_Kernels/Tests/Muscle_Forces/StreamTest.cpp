          ...
          for (int i = 0; i < 16; i += 1)
            {
              ...
              Muscle_Forces < float, float[16], int[16] > (fk, fiberk, Ffiberk,
                                                           c1k, one_over_hk,
                                                           cell_volumek);
            }
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray6 cell_volumek =
                reinterpret_cast < refArray6 > (cell_volume[i]);
              Muscle_Forces < __m128, float[16], int[16] > (fk, fiberk, Ffiberk,
                                                            c1k, one_over_hk,
                                                            cell_volumek);
            }
          ...
          for (int i = 0; i < 16; i += 8)
            {
              ...
              refArray6 cell_volumek =
                reinterpret_cast < refArray6 > (cell_volume[i]);
              Muscle_Forces < __m256, float[16], int[16] > (fk, fiberk, Ffiberk,
                                                            c1k, one_over_hk,
                                                            cell_volumek);
            }
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray6 cell_volumek =
                reinterpret_cast < refArray6 > (cell_volume[i]);
              Muscle_Forces < float32x4_t, float[16], int[16] > (fk, fiberk,
                                                                 Ffiberk, c1k,
                                                                 one_over_hk,
                                                                 cell_volumek);
            }
          ...
          for (int i = 0; i < 16; i += 16)
            {
              ...
              refArray6 cell_volumek =
                reinterpret_cast < refArray6 > (cell_volume[i]);
              Muscle_Forces < __m512, float[16], int[16] > (fk, fiberk, Ffiberk,
                                                            c1k, one_over_hk,
                                                            cell_volumek);
            }
