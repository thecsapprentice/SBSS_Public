...
main (int argc, char *argv[])
{
  ...
  {
    std::cout << "Running Stream Test for Stress_Tensor_Differential " << std::
      endl;
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray5 dpk = reinterpret_cast < refArray5 > (dp[i]);
              refArray6 alphak = reinterpret_cast < refArray6 > (alpha[i]);
              Stress_Tensor_Differential < __m128, float[16],
                int[16] > (dP_hatk, dPdFk, dF_hatk, Q_hatk, dpk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 8)
            {
              ...
              refArray5 dpk = reinterpret_cast < refArray5 > (dp[i]);
              refArray6 alphak = reinterpret_cast < refArray6 > (alpha[i]);
              Stress_Tensor_Differential < __m256, float[16],
                int[16] > (dP_hatk, dPdFk, dF_hatk, Q_hatk, dpk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 4)
            {
              ...
              refArray5 dpk = reinterpret_cast < refArray5 > (dp[i]);
              refArray6 alphak = reinterpret_cast < refArray6 > (alpha[i]);
              Stress_Tensor_Differential < float32x4_t, float[16],
                int[16] > (dP_hatk, dPdFk, dF_hatk, Q_hatk, dpk, alphak);
            }
          ...
          for (int i = 0; i < 16; i += 16)
            {
              ...
              refArray5 dpk = reinterpret_cast < refArray5 > (dp[i]);
              refArray6 alphak = reinterpret_cast < refArray6 > (alpha[i]);
              Stress_Tensor_Differential < __m512, float[16],
                int[16] > (dP_hatk, dPdFk, dF_hatk, Q_hatk, dpk, alphak);
            }
