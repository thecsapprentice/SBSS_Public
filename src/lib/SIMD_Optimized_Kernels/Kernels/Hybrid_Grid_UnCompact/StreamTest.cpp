...
{
    pthread_queue=new PhysBAM::PTHREAD_QUEUE(6);
    ...
    while(1){
        start_timer ();
        Grid_UnCompact<float>(u_compact,p_compact,U[0],U[1],U[2],P,block_offsets,number_of_blocks,
