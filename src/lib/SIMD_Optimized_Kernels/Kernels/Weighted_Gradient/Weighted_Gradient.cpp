...
inline
#endif
void Weighted_Gradient(const T_DATA (&u)[3][8], T_DATA (&F)[9],const T_DATA (&W)[3], const T_DATA (&one_over_h))
{
    ...
    for( int v =0; v < 3; v++)
        {
            ...
            RuID0 = (RuI10 - RuI00) * ONE_OVER_H;
            RuID1 = (RuI11 - RuI01) * ONE_OVER_H;
            
            RuI0D = (RuI01 - RuI00) * ONE_OVER_H;
            RuI1D = (RuI11 - RuI10) * ONE_OVER_H;
            
            RuDI0 = (Ru1I0 - Ru0I0) * ONE_OVER_H;
            RuDI1 = (Ru1I1 - Ru0I1) * ONE_OVER_H;
...
#else
#define INSTANCE_KERNEL_Weighted_Gradient(WIDTH) const WIDETYPE(float,WIDTH) (&u)[3][8], WIDETYPE(float,WIDTH) (&F)[9], const WIDETYPE(float,WIDTH) (&W)[3], const WIDETYPE(float,WIDTH) (&one_over_h)
