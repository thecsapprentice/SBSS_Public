...
public:
    ...
    MATRIX<T,3> dP_hat(const MATRIX<T,3>& dF_hat) const // Contraction
    {
        MATRIX<T,3> dP_hat;
...
template<class T>
std::ostream& operator<< ( std::ostream& out, const ROTATED_STRESS_DERIVATIVE<T,2>& rsd )
{
    out << "[ " << rsd.a1111 << " " << rsd.a1122 << " " << rsd.a2222 << " " << rsd.a1212 << " " << rsd.a1221 << " ]";
    return out;
}

template<class T>
std::ostream& operator<< ( std::ostream& out, const ROTATED_STRESS_DERIVATIVE<T,3>& rsd )
{
    out << "[ " << rsd.a1111<< " " << rsd.a1122<< " " << rsd.a1133<< " " << rsd.a2222<< " " << rsd.a2233<< " " << rsd.a3333<< " " << rsd.a1212<< " " << rsd.a1221<< " " << rsd.a1313<< " " << rsd.a1331<< " " << rsd.a2323<< " " << rsd.a2332 << " ]";
    return out;
}
